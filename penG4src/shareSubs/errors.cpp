...
void ErrorFunction(int NERROR)
{
  ...
  if(NERROR == 0)
    ...
    {
      strcpy(REASON,"Fatal Error in PEINIT: Electron absorption energy less than 50 eV.");
    }
  else if(NERROR == 1002)
    {
      strcpy(REASON,"Fatal Error in PEINIT: Photon absorption energy less than 50 eV.");
    }
  else if(NERROR == 1003)
    {
      strcpy(REASON,"Fatal Error in PEINIT: Positron absorption energy less than 50 eV.");
    }
  else if(NERROR == 1004)
    {
      strcpy(REASON,"Fatal Error in PEINIT: The energy interval is too narrow");
    }
  else if(NERROR == 1005)
    {
      strcpy(REASON,"Fatal Error in PEINIT: Too many materials. Edit 'penelope.cpp' and change MAXMAT parameter");
    }
  else if(NERROR == 1006)
    {
      strcpy(REASON,"Fatal Error in PEINIT: The material data file could not be opened");
    }
  else if(NERROR == 1007)
    {
      strcpy(REASON,"Fatal Error in EGRID: The energy interval is too narrow");
    }
  else if(NERROR == 1008)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATR. Too many elements in the material composition. The maximum number of elements is 30");
    }
  else if(NERROR == 1011)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. This element has been declared twice.");
    }
  else if(NERROR == 1102)
    {
      strcpy(REASON,"Fatal Error in PEMATW. Fractions by weight are too small.");
    }
  else if(NERROR == 1103)
    {
      strcpy(REASON,"Fatal Error in PEMATW. This element has been declared twice.");
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. The allowed material ID numbers are 1-300.");
    }
  else if(NERROR == 1105)
    {
      strcpy(REASON,"Fatal Error in PEMATW. NELEM cannot be larger than 30.");
    }
  else if(NERROR == 1106)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. Abnormal termination of file ''pdcompos.pen''.");
    }
  else if(NERROR == 1108)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. STF (atoms/molecule) must be positive.");
    }
  else if(NERROR == 1110)
    {
      strcpy(REASON,"Fatal Error in PEMATW. Element has been declared twice.");
    }
  else if(NERROR == 1111)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. Too many oscillators. The parameter NOM should be increased.");
    }
  else if(NERROR == 1116)
    {
      strcpy(REASON,"Fatal Error in PEMATW. Unbalanced charges (compound).");
    }
  else if(NERROR == 1117)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. Inconsistent oscillator strength data.");
    }
  else if(NERROR == 1119)
    {
      strcpy(REASON,"Fatal Error in PEMATW. Inconsistent oscillator-strength data.");
    ...
    {
      strcpy(REASON,"Fatal Error in PEMATW. Inconsistent oscillator-strength data (2)."); 
    }
  else if(NERROR == 1121)
    {
      strcpy(REASON,"Fatal Error in PEMATW. Error in grouping the Compton profiles.");
    }
  else if(NERROR == 1201)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in STORES: Not enough storage for secondary positrons.");
    }
  else if(NERROR == 1204)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in BRAR. Corrupt data file (pdbrang.p08).");
    }
  else if(NERROR == 1326)
    {
      strcpy(REASON,"Fatal Error in BRAW. Corrupt data file (pdbrang.p08).");
    }
  else if(NERROR == 1327)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GRAaR. RITA interpolation error is too large.");
    }
  else if(NERROR == 1329)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in RELAXR. Negative transition probability?");
    }
  else if(NERROR == 1343)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in EELdW. Electron cross section data are corrupt.");
    }
  else if(NERROR == 1347)
    {
      strcpy(REASON,"Fatal Error in EELdW. Positron cross section data are corrupt.");
    }
  else if(NERROR == 1348)
    {
      strcpy(REASON,"Fatal Error in EELdR. Error reading electron elastic DCS data.");
    }
  else if(NERROR == 1349)
    {
      strcpy(REASON,"Fatal Error in EELdR. Electron cross section data are corrupt.");
    }
  else if(NERROR == 1350)
    {
      strcpy(REASON,"Fatal Error in EELdR. Error reading positron elastic DCS data.");
    }
  else if(NERROR == 1351)
    {
      strcpy(REASON,"Fatal Error in EELdR. Positron cross section data are corrupt.");
    }
  else if(NERROR == 1352)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in RITAI0: XLOW must be larger than XHIGH.");
    }
  else if(NERROR == 1405)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in MERGE2. Increase the value of the parameter NP.");
    }
  else if(NERROR == 1902)
    {
      strcpy(REASON,"Fatal Error in MERGE2. Increase the value of the parameter NP.");
    ...
    {
      strcpy(REASON,"Fatal Error in SORT2. Increase the value of the parameter NP.");
    }
  else if(NERROR == 1904)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in SPLINE: X values not in increasing order.");
    }
  else if(NERROR == 1906)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The input and output units must be different.");
    }
  else if(NERROR == 2002)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The parameter NS must be increased.");
    }
  else if(NERROR == 2006)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: Incorrect format of surface indices.");
    }
  else if(NERROR == 2007)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: NPINP is too small (check PARINP).");
    }
  else if(NERROR == 2009)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: X-scale factor less than 1.0E-15.)");
    }
  else if(NERROR == 2010)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: Y-scale factor less than 1.0E-15.)");
    }
  else if(NERROR == 2011)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: Z-scale factor less than 1.0E-15.)");
    }
  else if(NERROR == 2012)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: What do you mean?");
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: Same label for two bodies (or modules).");
    }
  else if(NERROR == 2019)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The parameter NB must be increased.");
    }
  else if(NERROR == 2020)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: Incorrect material definition line.");
    }
  else if(NERROR == 2021)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The last limiting surface has been defined twice.");
    }
  else if(NERROR == 2023)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The number of limiting surfaces is too large.");
    }
  else if(NERROR == 2024)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: You are trying to assign two mothers to the last body.");
    }
  else if(NERROR == 2043)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The number of limiting surfaces is too large.");
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: You are trying to assign two mothers to the last module.");
    }
  else if(NERROR == 2047)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The number of limiting surfaces is too large.");
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The cloned object must be a module.");
    }
  else if(NERROR == 2054)
    {
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The selected object is a body.");
    }
  else if(NERROR == 2056)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The label does not correspond to a module.");
    }
  else if(NERROR == 2057)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: What do you mean?");
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The limiting body or module is not yet defined");
    }
  else if(NERROR == 2064)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The limiting body or module is not yet defined");
    ...
    {
      strcpy(REASON,"Fatal Error in GEOMIN: The parameter NXG is too small.");
    }   
  else if(NERROR == 2072)
    {
      strcpy(REASON,"Fatal Error in GEOMIN: Possibly unresolved body or module.");
    }
  else if(NERROR == 2073)
    {
  ...
  //ERRORS PENEASY
    ...
    {
      strcpy(REASON,"samplePosition:ERROR: sampling source efficiency is lower than 0.1%%.");
    }
  else if(NERROR == 147)
    {
    ...
    {
      strcpy(REASON,"iniconfig:ERROR: interval between dumps must be positive.");
    }
  else if(NERROR == 154)
    {
    ...
    {
      strcpy(REASON,"inigeo:ERROR: too many materials; enlarge MAXMAT parameter and recompile.");
    }
  else if(NERROR == 158)
    {
    ...
    {
      strcpy(REASON,"inipen:ERROR: DSMAX must be larger than zero even if electrons are not transported.");
    }
  else if(NERROR == 165)
    {
      strcpy(REASON,"inipen:ERROR: There are more materials declared in the geometry file than defined in the config file.");
    }
  else if(NERROR == 166)
    {
    ...
    {
      strcpy(REASON,"BIGSinisrc:ERROR: invalid polarization switch, should be 0 or 1");
    }
  else if(NERROR == 175)
    {
      strcpy(REASON,"BIGSinisrc:ERROR: vector P={P1,P2,P3} must be P^2 <= 1");
    }
  else if(NERROR == 176)
    {
    ...
    {
      strcpy(REASON,"inisource:ERROR: PSF source ON is incompatible with other sources ON.");
    }
  else if(NERROR == 189)
    {
    ...
    {
      strcpy(REASON,"EDPinitally:ERROR: Unable to find End-Of-Section mark");
    }
  else if(NERROR == 191)
    {
    ...
    {
      strcpy(REASON,"iniforce:ERROR: unable to read line containing: MAT,KPAR,ICOL,forcing");
    }
  else if(NERROR == 196)
    {
    ...
    {
      strcpy(REASON,"inisplit:ERROR: Photon polarization is active. Only simple splitting can be used");
    }
  else if(NERROR == 207)
    {
    ...
    {
      strcpy(REASON,"inivox:ERROR: there must be ONE body with transparent material.");
    }
  else if(NERROR == 220)
    {
      strcpy(REASON,"inivox:ERROR: granularity must be between 2 and maxGranul");
    }
  else if(NERROR == 221)
    {
      strcpy(REASON,"inivox:ERROR: internal inconsistency; expecting vacuum");
    }
  else if(NERROR == 222)
    {
    ...
    {
      strcpy(REASON,"readvox:ERROR: column numbers must be between 1 and maxCol.");
    }
   else if(NERROR == 233)
    {
    ...
    {
      strcpy(REASON,"SDDinitally:ERROR: Unable to find End-Of-Section mark.");
    }
   else if(NERROR == 238)
    {
    ...
    {
      strcpy(REASON,"SDDinitally:ERROR: nbinmax max no. of megabins exceeded.");
    }
   else if(NERROR == 242)
    {
    ...
    {
      strcpy(REASON,"PSFinitally:ERROR: Unable to find End-Of-Section mark.");
    }
   else if(NERROR == 247)
    {
    ...
    {
      strcpy(REASON,"PSFinitally:ERROR: IAEA PSF format requested but not available.");
    }
   else if(NERROR == 249)
    {
    ...
    {
      strcpy(REASON,"PSFinitally:ERROR: detection material out of range: 1,MAXMAT.");
    }
   else if(NERROR == 251)
    {
      strcpy(REASON,"PSFinitally:ERROR: PSF detection material must be a perfect absorbent.");
    }
   else if(NERROR == 252)
    {
    ...
    {
      strcpy(REASON,"IAEAiniwrite:ERROR: Could not open PSF to append; make sure the file exists and it is accessible.");
    }
   else if(NERROR == 256)
    {
    ...
    {
      strcpy(REASON,"IAEAiniwrite:internalERROR: Extra variable index is out of range.");
    }
   else if(NERROR == 258)
    {
      strcpy(REASON,"IAEAiniwrite:internalERROR: Extra variable type is out of range.");
    }
   else if(NERROR == 259)
    {
      strcpy(REASON,"IAEAiniwrite:internalERROR: Undefined error while setting an extra variable.");
    }
   else if(NERROR == 260)
    {
    ...
    {
      strcpy(REASON,"VDDinitially:ERROR: voxel dose tally is ON but no voxelized geometry has been defined.");
    }
   else if(NERROR == 265)
    {
      strcpy(REASON,"VDDinitally:ERROR: Unable to find End-Of-Section mark.");
    }
   else if(NERROR == 266)
    {
    ...
    {
      strcpy(REASON,"CDDinitally:ERROR: Unable to find End-Of-Section mark.");
    }
   else if(NERROR == 273)
    {
    ...
    {
      strcpy(REASON,"PSFinisrc:ERROR: IAEA PSF format requested but not available.");
    }
   else if(NERROR == 281)
    {
    ...
    {
      strcpy(REASON,"PSFinisrc:ERROR: invalid entry. VALIDATE field must be 0 or 1.");
    }
   else if(NERROR == 284)
    {
    ...
    {
      strcpy(REASON,"PSFinisrc:ERROR: No. of histories in PSF exceeds nmax.");
    }
   else if(NERROR == 286)
    {
    ...
    {
      strcpy(REASON,"PSFinisrc:ERROR: null vector direction found at line:.");
    }
   else if(NERROR == 289)
    {
      strcpy(REASON,"PSFinisrc:ERROR: PSF end-of-file reached, not enough particles to initialize.");
    }
   else if(NERROR == 290)
    {
      strcpy(REASON,"PSFinisrc:ERROR: Inconsistency found in PSF incremental history no.");
    }
   else if(NERROR == 291)
    {
    ...
    {
      strcpy(REASON,"getparIAEA:ERROR: EOF reached when attempting to read particle no.:.\n");
    }
   else if(NERROR == 299)
    {
      strcpy(REASON,"getparIAEA:ERROR: undefined error while attempting to read particle no.:.\n");
    }
   else if(NERROR == 300)
    {
      strcpy(REASON,"getparIAEA:ERROR: Invalid KPAR: found at particle no.:\n");
    }
   else if(NERROR == 301)
    {
    ...
    {
      strcpy(REASON,"IAEAiniread:ERROR: Unable to get the total number of particles.\n");
    }
   else if(NERROR == 303)
    {
      strcpy(REASON,"IAEAiniread:ERROR: Unable to get the total number of histories.\n");
    }
   else if(NERROR == 304)
    {
      strcpy(REASON,"IAEAiniread:ERROR: No. of histories in PSF exceeds nmax.\n");
    }
   else if(NERROR == 305)
    {
      strcpy(REASON,"IAEAiniread:ERROR: Unable to get constant variables.\n");
    }
   else if(NERROR == 306)
    {
      strcpy(REASON,"IAEAiniread:ERROR: Variable constant index out of range.\n");
    }
   else if(NERROR == 307)
    {
      strcpy(REASON,"IAEAiniread:ERROR: More than xtraMax extra int or real variables in PSF.\n");
    }
   else if(NERROR == 308)
    {
      strcpy(REASON,"IAEAiniread:ERROR: Unable to check file size and byte order of the PSF.\n");
    }
   else if(NERROR == 309)
    {
    ...
    {
      strcpy(REASON,"IAEAiniread:ERROR: File size inconsistent with header checksum.\n");
    }
   else if(NERROR == 311)
    {
    ...
    {
      strcpy(REASON,"IAEAiniread:ERROR: There is a file size and byte order mismatch.\n");
    }
   else if(NERROR == 313)
    {
    ...
    {
      strcpy(REASON,"IAEAiniread:ERROR: energy out of range found in particle no.:.\n");
    }
   else if(NERROR == 316)
    {
      strcpy(REASON,"IAEAiniread:ERROR: null direction vector found in particle no.:.\n");
    }
   else if(NERROR == 317)
    {
      strcpy(REASON,"IAEAiniread:ERROR: No. of particles inferred from PSF differs from that stated in header file.\n");
    }
   else if(NERROR == 318)
    {
      strcpy(REASON,"IAEAiniread:ERROR: No. of histories inferred from PSF is greater than that stated in header file.\n");
    }
   else if(NERROR == 319)
    {
    ...
    {
      strcpy(REASON,"IAEAiniread:ERROR: PSF end-of-file reached, not enough particles to initialize.\n");
    }
   else if(NERROR == 323)
    {
      strcpy(REASON,"IAEAiniread:ERROR: Inconsistency found in PSF incremental history.\n");
    }
   else if(NERROR == 324)
    {
      strcpy(REASON,"PSFinitally:ERROR: incorrect section header.\n");
    ...
    {
      strcpy(REASON,"PSFinitally:ERROR: detection material out of range.\n");
    }
   else if(NERROR == 330)
    {
      strcpy(REASON,"PSFinitally:ERROR: PSF detection material must be a perfect absorbent.\n");
    ...
    {
      strcpy(REASON,"IAEAwriteReport:ERROR: unable to write no. of histories to header file.\n");
    }
   else if(NERROR == 334)
    {
      strcpy(REASON,"IAEAwriteReport:ERROR: unable to update header file.\n");
    }
   else if(NERROR == 335)
    {
    ...
    {
      strcpy(REASON,"FTLinitally:ERROR: Unable to find End-Of-Section mark.\n");
    }
   else if(NERROR == 337)
    {
    ...
    {
      strcpy(REASON,"PCSinitally:ERROR: Unable to find End-Of-Section mark.\n");
    }
   else if(NERROR == 342)
    {
    ...
    {
      strcpy(REASON,"PTSinitally:ERROR: Unable to find End-Of-Section mark.\n");
    }
   else if(NERROR == 347)
    {
    ...
    {
      strcpy(REASON,"SPDinitally:ERROR: Unable to find End-Of-Section mark.\n");
    }
   else if(NERROR == 352)
    {
    ...
    {
      strcpy(REASON,"PHSinitally:ERROR: Unable to find End-Of-Section mark.\n");
    }
   else if(NERROR == 358)
    {
    ...
    {
      strcpy(REASON,"PIDinitally:ERROR: Unable to find End-Of-Section mark.\n");
    }
   else if(NERROR == 364)
    {
    ...
    {
      strcpy(REASON,"PIDinitally:ERROR: detection material must be a perfect absorbent; increase absorption energies above einf.\n");
    }
   else if(NERROR == 367)
    {
    ...
    {
      strcpy(REASON,"PIDinitally:ERROR: pixel size and no. pixels are both zero.\n");
    }
   else if(NERROR == 369)
    {
    ...
    {
      strcpy(REASON,"PIDinitally:ERROR: emin, emax, nebin invalid values.\n");
    }
   else if(NERROR == 371)
    {
    ...
    {
      strcpy(REASON,"PIDinitally:ERROR: max no. (Mpixels x E bins) exceeded.\n");
    }
   else if(NERROR == 373)
    {
      strcpy(REASON,"PIDinitally:ERROR: c0, c1 parameters cannot be negative.\n");
    }
   else if(NERROR == 374)
    {
      strcpy(REASON,"PIDinitally:ERROR: Matrix format is incompatible with energy discriminating mode.\n");
    }
   else if(NERROR == 375)
    {
    ...
    {
      strcpy(REASON,"setDetectFrame:ERROR: detection material not found.\n");
    }

   else if(NERROR == 400)
    {
      strcpy(REASON,"PMRDR:ERROR: The input file must begin with the TITLE line.\n");
    }
   else if(NERROR == 401)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: Source energy spectrum. The number of energy bins is too large.\n");
    }
   else if(NERROR == 403)
    {
      strcpy(REASON,"PMRDR:ERROR: The source energy spectrum is not defined.\n");
    }
   else if(NERROR == 404)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: Inconsistent definition of the primary source.\n");
    }
   else if(NERROR == 410)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: You have to specify a material file (line MFNAME).\n");
    }
   else if(NERROR == 413)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: Interaction forcing unactive in this body.\n");
    }
   else if(NERROR == 429)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: No impact detector has been defined yet.\n");
    }
   else if(NERROR == 438)
    {
      strcpy(REASON,"PMRDR:ERROR: Only one PSF can be generated in a each run.\n");
    }
   else if(NERROR == 439)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: A body cannot be part of two detectors.\n");
    }
   else if(NERROR == 444)
    {
      strcpy(REASON,"PMRDR:ERROR: A void body cannot be part of a detectors.\n");
    }
   else if(NERROR == 445)
    {
    ...
    {
      strcpy(REASON,"PMRDR:ERROR: The dump file is corrupted (the TITLE does not match).\n");
    }
   else if(NERROR == 452)
    {
    ...
    {
      strcpy(REASON,"IMDET0:ERROR: SIMDET: Detector already defined. Detector cannot be defined.\n");
    }
   else if(NERROR == 458)
    {
    ...
    {
      strcpy(REASON,"ENDET0:ERROR: SENDET: Detector already defined. Detector cannot be defined.\n");
    }
   else if(NERROR == 461)
    {
    ...
    {
      strcpy(REASON,"DOSE0:ERROR: SDOSE: NBX must be .GT.0. and .LE.NDXM\n");
    }
   else if(NERROR == 465)
    {
      strcpy(REASON,"DOSE0:ERROR: SDOSE: NBY must be .GT.0. and .LE.NDYM\n");
    }
   else if(NERROR == 466)
    {
      strcpy(REASON,"DOSE0:ERROR: SDOSE: NBZ must be .GT.0. and .LE.NDZM\n");
    }
   else if(NERROR == 1000)
    {
      strcpy(REASON,"");
  ...
  std::cout << "PenG4 ERROR: " << NERROR << ". "
	    << REASON << std::endl;
   
/*
  //Destruccio de vectors

  //PENGEOM_mod

  for(unsigned int i = 0; i < PENGEOM_mod::NB; i++)
    {
      delete [] PENGEOM_mod::BALIAS[i];
    }
  delete [] PENGEOM_mod::BALIAS;
  delete [] PENGEOM_mod::MATER;
  delete [] PENGEOM_mod::KDET;
  ...
  for(unsigned int i = 0; i < PENGEOM_mod::NB; i++)
    {
      delete [] QTREE::KDGHT[i];
      delete [] QTREE::KSURF[i];
      delete [] QTREE::KFLAG[i];      
    }
  delete [] QTREE::KDGHT;
  delete [] QTREE::KSURF;
  delete [] QTREE::KFLAG;
